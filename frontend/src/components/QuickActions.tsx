  ...
  if (user?.role === 'brand') {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <Link to="/sponsorships/create" className="card p-4 hover-lift flex flex-col items-center justify-center text-center h-32 group transition-all duration-300 border border-gray-200 dark:border-gray-700">
          <div className="w-10 h-10 bg-primary-light/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link to="/brand-profile" className="card p-4 hover-lift flex flex-col items-center justify-center text-center h-32 group transition-all duration-300 border border-gray-200 dark:border-gray-700">
        ...
        <Link to="/search" className="card p-4 hover-lift flex flex-col items-center justify-center text-center h-32 group transition-all duration-300 border border-gray-200 dark:border-gray-700">
          <div className="w-10 h-10 bg-accent/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-accent group-hover:text-white transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-accent group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link to="/analytics" className="card p-4 hover-lift flex flex-col items-center justify-center text-center h-32 group transition-all duration-300 border border-gray-200 dark:border-gray-700">
          <div className="w-10 h-10 bg-primary-light/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <Link to="/sponsorships" className="card p-4 hover-lift flex flex-col items-center justify-center text-center h-32 group transition-all duration-300 border border-gray-200 dark:border-gray-700">
          <div className="w-10 h-10 bg-primary-light/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
        ...
        <Link to="/profile" className="card p-4 hover-lift flex flex-col items-center justify-center text-center h-32 group transition-all duration-300 border border-gray-200 dark:border-gray-700">
          <div className="w-10 h-10 bg-secondary-light/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-secondary group-hover:text-white transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-secondary group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
